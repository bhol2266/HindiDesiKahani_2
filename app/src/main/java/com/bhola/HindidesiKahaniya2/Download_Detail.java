    ...
    private void actionBar() {
        ...
        VipMembership.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (SplashScreen.isInternetAvailable(Download_Detail.this)) {
                    startActivity(new Intent(Download_Detail.this, VipMembership.class));

                } else {
                    Toast.makeText(Download_Detail.this, "Check Internet Connection!", Toast.LENGTH_SHORT).show();
                }
            }
        });
