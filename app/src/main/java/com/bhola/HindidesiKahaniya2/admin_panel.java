...
public class admin_panel extends AppCompatActivity {
        ...
        Ad_Network.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Ad_Network.getText().toString().equals("admob")) {
                    mref.child("Hindi_desi_Kahani-2").child("Ad_Network").setValue("facebook");
                    Ad_Network.setBackgroundColor(Color.parseColor("#D11A1A"));

                } else {
                    mref.child("Hindi_desi_Kahani-2").child("Ad_Network").setValue("admob");
    ...
    private void appControl() {
        ...
        switch_Exit_Nav.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    mref.child("Hindi_desi_Kahani-2").child("switch_Exit_Nav").setValue("active");
                } else {
                    mref.child("Hindi_desi_Kahani-2").child("switch_Exit_Nav").setValue("inactive");
                }
        ...
        switch_Activate_Ads.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    mref.child("Hindi_desi_Kahani-2").child("Ads").setValue("active");
                } else {
                    mref.child("Hindi_desi_Kahani-2").child("Ads").setValue("inactive");
                }
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    if (SplashScreen.Sex_Story_Switch_Open.equals("active")) {
                        mref.child("Hindi_desi_Kahani-2").child("Sex_Story").setValue("active");
                    }
                } else {
                    mref.child("Hindi_desi_Kahani-2").child("Sex_Story").setValue("inactive");
                }
            }
        });
        ...
        STory_Switch_Active_BTN.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (STory_Switch_Active_BTN.getText().toString().trim().equals("Disabled")) {
                    mref.child("Hindi_desi_Kahani-2").child("Sex_Story_Switch_Open").setValue("active");
                } else
                    mref.child("Hindi_desi_Kahani-2").child("Sex_Story_Switch_Open").setValue("inactive");
            }
        });
    ...
    private void checkButtonState() {
        ...
        mref.child("Hindi_desi_Kahani-2").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
