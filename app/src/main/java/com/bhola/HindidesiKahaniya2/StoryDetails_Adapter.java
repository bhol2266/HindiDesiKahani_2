...
public class StoryDetails_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        if (storyItemModel.getRead() == 1) {
            storyRowViewHolder.title.setTextColor(ContextCompat.getColor(context, R.color.read_color));
        } else {
            storyRowViewHolder.title.setTextColor(ContextCompat.getColor(context, R.color.unread_color));
        }
